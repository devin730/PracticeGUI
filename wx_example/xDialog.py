...
class InputDialog(wx.Dialog):
    ...
    def InitUI(self):
        panel = wx.Panel(self)
        font = wx.Font(14, wx.DEFAULT, wx.NORMAL, wx.NORMAL, False, 'Microsoft yahei')
        accountLabel = wx.StaticText(panel, -1, '账号', pos=(20, 25))
        accountLabel.SetForegroundColour(self.themeColor)
        accountLabel.SetFont(font)

        self.accountInput = wx.TextCtrl(panel,
                                        -1,
                                        u'',
                                        pos=(80, 25),
                                        size=(180, -1))
        ...
        self.passwordInput = wx.TextCtrl(panel,
                                         -1,
                                         u'',
                                         pos=(80, 70),
                                         size=(180, -1),
